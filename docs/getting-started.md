...
| **Fix overlapping skills**               | Optimization    | `reach optimize <skill>`        | Synthesizes candidate descriptions and benchmarks them with fast probes, optionally auto-applying the winning rewrite to `SKILL.md`.                                |
